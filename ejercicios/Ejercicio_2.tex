...
\end{align*}
para toda $s\in I$ y $H_1(0,t)=H_1(1,t)=H(0,1-t)=H_1(1,1-t)=x_0$ para toda $t\in I$. Por lo tanto, $H_1$ es testigo de que $\beta\simeq \alpha$. (3) Supongamos $\alpha\simeq\beta$ y $\beta\simeq \gamma$. Entonces, existen $H_1,H_2:I\times I\to X$ continuas tales que
\begin{enumerate}[label=(\arabic*)]
